package com.freeying.admin.number.support.poi;
...
import com.freeying.admin.number.support.annotation.Excel.Type;
import com.freeying.admin.number.support.annotation.Excels;
import com.freeying.admin.number.support.utils.Convert;
import com.freeying.admin.number.support.utils.DateUtils;
import com.freeying.admin.number.support.utils.StringUtils;
import com.freeying.admin.number.support.utils.file.FileTypeUtils;
import com.freeying.admin.number.support.utils.file.ImageUtils;
...
public class ExcelUtil<T> {
    ...
    public Result<String> exportExcel() {
        ...
        try {
            ...
            wb.write(out);
            return Result.success(filename, ResultCode.SUCCESS.getMessage());
        } catch (Exception e) {
            log.error("导出Excel异常{}", e.getMessage());
