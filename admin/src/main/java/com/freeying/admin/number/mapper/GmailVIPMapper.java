...
@Mapper
public interface GmailVIPMapper extends PlusBaseMapper<GmailVIP> {
     ...
     * @return 分页对象
     */
    PageInfo<GmailVIP> selectGmailVIPPage(@Param("page") PageInfo<?> pageInfo, @Param("qry") TgVIPPageQuery qry);
     ...
     * @return 分页对象
     */
    PageInfo<GmailVIP> selectGmailVIPLogPage(@Param("page") PageInfo<?> pageInfo, @Param("qry") TgVIPLogPageQuery qry, @Param("userId") Long userId);
     ...
     * @return 内容
     */
    List<GmailVIP> getTakeContent(@Param("count") Integer count);
