...
@Mapper
public interface AppleGiftMapper extends PlusBaseMapper<AppleGift> {
     ...
     * @return 分页对象
     */
    PageInfo<AppleGift> selectAppleGiftPage(@Param("page") PageInfo<?> pageInfo, @Param("qry") TgVIPPageQuery qry);
     ...
     * @return 分页对象
     */
    PageInfo<AppleGift> selectAppleGiftLogPage(@Param("page") PageInfo<?> pageInfo, @Param("qry") TgVIPLogPageQuery qry, @Param("userId") Long userId);
     ...
     * @return 内容
     */
    List<AppleGift> getTakeContent(@Param("count") Integer count);
